package simpli.learn.finalprojectone;
...
public class Operations implements FileUtility {
	...
	File[] files = new File("D:\\javaprojectdocuments").listFiles();
	@Override
	...
	public void searchFile() {
		...
		try {	
			Scanner scan= new Scanner(System.in);
			File directory = new File("C:\\javaprojectdocuments");
	...
	*/
	...
	public void searchFile() throws FileNotFoundException{
		Scanner scan= new Scanner(System.in);
		File directory = new File("D:\\javaprojectdocuments");
		System.out.println("Enter the file name which you want to search:");
		String fileName=scan.nextLine();
		File[] files=directory.listFiles();
		int flag=0;
